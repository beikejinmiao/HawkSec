...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.whiteDomEnableBox.setGeometry(QtCore.QRect(570, 130, 80, 20))
        self.whiteDomEnableBox.setObjectName("whiteDomEnableBox")
        self.checkWhiteDomBtn = QtWidgets.QPushButton(Form)
        self.checkWhiteDomBtn.setGeometry(QtCore.QRect(570, 240, 61, 24))
        ...
        self.saveBtn.setGeometry(QtCore.QRect(310, 470, 61, 24))
        self.saveBtn.setObjectName("saveBtn")
        self.exitBtn = QtWidgets.QPushButton(Form)
        self.exitBtn.setGeometry(QtCore.QRect(390, 470, 61, 24))
        self.exitBtn.setObjectName("exitBtn")
        self.checkWhiteFileBtn = QtWidgets.QPushButton(Form)
        self.checkWhiteFileBtn.setGeometry(QtCore.QRect(570, 430, 61, 24))
    ...
    def retranslateUi(self, Form):
        ...
        self.whiteDomTextEdit.setPlaceholderText(_translate("Form", "多个域名请以逗号或者换行符分割; 格式错误域名将被忽略"))
        ...
        self.whiteFileTextEdit.setPlaceholderText(_translate("Form", "多个文件路径请以逗号或者换行符分割; 不校验文件名"))
