...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.exitBtn.setGeometry(QtCore.QRect(390, 440, 61, 24))
    ...
    def retranslateUi(self, Form):
        ...
        self.whiteDomTextEdit.setPlaceholderText(_translate("Form", "多个域名请以逗号或者换行符分割\n注意: 格式错误域名将被忽略"))
        ...
        self.whiteFileTextEdit.setPlaceholderText(_translate("Form", "多个文件路径请以逗号或者换行符分割\n注意: 不校验文件名格式"))
