...
"}")
        ...
        self.layoutWidget_13.setGeometry(QtCore.QRect(50, 10, 881, 501))
        ...
        self.extUrlWaitingWidget = QtWidgets.QWidget(self.detailWidget)
        self.extUrlWaitingWidget.setGeometry(QtCore.QRect(20, 17, 21, 21))
        self.extUrlWaitingWidget.setMinimumSize(QtCore.QSize(21, 21))
        self.extUrlWaitingWidget.setObjectName("extUrlWaitingWidget")
        self.gridLayoutWidget_4 = QtWidgets.QWidget(self.extUrlWaitingWidget)
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(0, 0, 21, 21))
        self.gridLayoutWidget_4.setObjectName("gridLayoutWidget_4")
        self.extUrlWaitingLayout = QtWidgets.QGridLayout(self.gridLayoutWidget_4)
        self.extUrlWaitingLayout.setContentsMargins(0, 0, 0, 0)
        self.extUrlWaitingLayout.setObjectName("extUrlWaitingLayout")
        self.idcardWaitingWidgt = QtWidgets.QWidget(self.detailWidget)
        self.idcardWaitingWidgt.setGeometry(QtCore.QRect(20, 188, 21, 21))
        self.idcardWaitingWidgt.setMinimumSize(QtCore.QSize(21, 21))
        self.idcardWaitingWidgt.setObjectName("idcardWaitingWidgt")
        self.gridLayoutWidget_6 = QtWidgets.QWidget(self.idcardWaitingWidgt)
        self.gridLayoutWidget_6.setGeometry(QtCore.QRect(0, 0, 21, 21))
        self.gridLayoutWidget_6.setObjectName("gridLayoutWidget_6")
        self.idcardWaitingLayout = QtWidgets.QGridLayout(self.gridLayoutWidget_6)
        self.idcardWaitingLayout.setContentsMargins(0, 0, 0, 0)
        self.idcardWaitingLayout.setObjectName("idcardWaitingLayout")
        self.keywordWaitingWidget = QtWidgets.QWidget(self.detailWidget)
        self.keywordWaitingWidget.setGeometry(QtCore.QRect(20, 362, 21, 21))
        self.keywordWaitingWidget.setMinimumSize(QtCore.QSize(21, 21))
        self.keywordWaitingWidget.setObjectName("keywordWaitingWidget")
        self.gridLayoutWidget_7 = QtWidgets.QWidget(self.keywordWaitingWidget)
        self.gridLayoutWidget_7.setGeometry(QtCore.QRect(0, 0, 21, 21))
        self.gridLayoutWidget_7.setObjectName("gridLayoutWidget_7")
        self.keywordWaitingLayout = QtWidgets.QGridLayout(self.gridLayoutWidget_7)
