...
"}")
        ...
        self.mobileCheckBox = QtWidgets.QCheckBox(self.sensiTypeFrame)
        self.mobileCheckBox.setGeometry(QtCore.QRect(280, 10, 80, 20))
        self.mobileCheckBox.setObjectName("mobileCheckBox")
        ...
        self.mobileGridLayout = QtWidgets.QGridLayout()
        self.mobileGridLayout.setHorizontalSpacing(3)
        self.mobileGridLayout.setVerticalSpacing(2)
        self.mobileGridLayout.setObjectName("mobileGridLayout")
        ...
        self.mobileGridLayout.addWidget(self.label_22, 0, 1, 1, 1)
        self.mobileTextEdit = QtWidgets.QTextEdit(self.layoutWidget_13)
        self.mobileTextEdit.setObjectName("mobileTextEdit")
        self.mobileGridLayout.addWidget(self.mobileTextEdit, 1, 1, 1, 3)
        self.mobileWaitingWidget = QtWidgets.QWidget(self.layoutWidget_13)
        self.mobileWaitingWidget.setMinimumSize(QtCore.QSize(24, 22))
        self.mobileWaitingWidget.setMaximumSize(QtCore.QSize(30, 22))
        self.mobileWaitingWidget.setObjectName("mobileWaitingWidget")
        self.verticalLayoutWidget_5 = QtWidgets.QWidget(self.mobileWaitingWidget)
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(0, 0, 31, 21))
        self.verticalLayoutWidget_5.setObjectName("verticalLayoutWidget_5")
        self.mobileWaitingLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_5)
        self.mobileWaitingLayout.setContentsMargins(0, 0, 0, 0)
        self.mobileWaitingLayout.setObjectName("mobileWaitingLayout")
        self.mobileGridLayout.addWidget(self.mobileWaitingWidget, 0, 0, 1, 1)
        self.mobileCntLabel = QClickLabel(self.layoutWidget_13)
        self.mobileCntLabel.setMaximumSize(QtCore.QSize(150, 16777215))
        self.mobileCntLabel.setStyleSheet("font-size: 20px;color: #2358DE;")
        self.mobileCntLabel.setObjectName("mobileCntLabel")
        self.mobileGridLayout.addWidget(self.mobileCntLabel, 0, 2, 1, 1)
        self.label_6 = QtWidgets.QLabel(self.layoutWidget_13)
        self.label_6.setText("")
        self.label_6.setObjectName("label_6")
        self.mobileGridLayout.addWidget(self.label_6, 0, 3, 1, 1)
        self.mobileGridLayout.setColumnStretch(0, 1)
        self.detailVLayout.addLayout(self.mobileGridLayout)
        ...
        self.extUrlFrame.setGeometry(QtCore.QRect(150, 330, 134, 81))
        ...
        self.idcardFrame.setGeometry(QtCore.QRect(490, 330, 134, 75))
        ...
        self.keywordFrame.setGeometry(QtCore.QRect(660, 330, 134, 75))
        ...
        self.mobileFrame = QtWidgets.QFrame(self.mainFrame2)
        self.mobileFrame.setGeometry(QtCore.QRect(320, 330, 134, 81))
        self.mobileFrame.setMinimumSize(QtCore.QSize(134, 75))
        ...
        self.mobileCntLabel2 = QClickLabel(self.mobileFrame)
        self.mobileCntLabel2.setGeometry(QtCore.QRect(30, 50, 91, 16))
        self.mobileCntLabel2.setStyleSheet("font-size: 20px;color: #2358DE;")
        self.mobileCntLabel2.setObjectName("mobileCntLabel2")
        self.layoutWidget_5 = QtWidgets.QWidget(self.mobileFrame)
        self.layoutWidget_5.setGeometry(QtCore.QRect(10, 10, 125, 23))
        self.layoutWidget_5.setObjectName("layoutWidget_5")
        self.horizontalLayout_15 = QtWidgets.QHBoxLayout(self.layoutWidget_5)
        self.horizontalLayout_15.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_15.setObjectName("horizontalLayout_15")
        self.mobileIconLabel = QtWidgets.QLabel(self.layoutWidget_5)
        self.mobileIconLabel.setMinimumSize(QtCore.QSize(14, 14))
        self.mobileIconLabel.setMaximumSize(QtCore.QSize(14, 14))
        self.mobileIconLabel.setObjectName("mobileIconLabel")
        self.horizontalLayout_15.addWidget(self.mobileIconLabel)
        self.label_21 = QtWidgets.QLabel(self.layoutWidget_5)
        self.label_21.setStyleSheet("font-size: 16px; color: #000000;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mobileCheckBox.setText(_translate("MainWindow", "手机号码"))
        ...
        self.label_22.setText(_translate("MainWindow", "手机号码数量"))
        self.mobileCntLabel.setText(_translate("MainWindow", "0"))
        ...
        self.mobileCntLabel2.setText(_translate("MainWindow", "0"))
        self.mobileIconLabel.setText(_translate("MainWindow", "pic"))
        self.label_21.setText(_translate("MainWindow", "手机号码数量"))
