...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QtCore.QRect(170, 60, 222, 32))
        ...
        self.timeoutComboBox = QtWidgets.QComboBox(self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(170, 310, 101, 26))
        self.widget1.setObjectName("widget1")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.widget1)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.label_7 = QtWidgets.QLabel(self.widget1)
        self.label_7.setStyleSheet("font-size: 14px; color: #2358DE;")
        self.label_7.setObjectName("label_7")
        self.horizontalLayout_2.addWidget(self.label_7)
        self.checkWhiteFileBtn = QtWidgets.QPushButton(self.widget1)
        ...
        self.widget2.setGeometry(QtCore.QRect(170, 120, 101, 26))
        self.widget2.setObjectName("widget2")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.widget2)
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_6 = QtWidgets.QLabel(self.widget2)
        self.label_6.setStyleSheet("font-size: 14px; color: #2358DE;")
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_3.addWidget(self.label_6)
        self.checkWhiteDomBtn = QtWidgets.QPushButton(self.widget2)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_7.setText(_translate("Form", "导入TXT"))
        self.checkWhiteFileBtn.setText(_translate("Form", "查看"))
        self.label_6.setText(_translate("Form", "导入TXT"))
